...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SplashWidget() : SignUpWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'lifeline',
          path: '/lifeline',
          builder: (context, params) => LifelineWidget(),
        ),
        FFRoute(
          name: 'quizPage2',
          path: '/quizPage2',
        ...
        FFRoute(
          name: 'lifeline2',
          path: '/lifeline2',
          builder: (context, params) => Lifeline2Widget(),
        ),
        FFRoute(
          name: 'lifeline3',
          path: '/lifeline3',
          builder: (context, params) => Lifeline3Widget(),
        ),
        FFRoute(
          name: 'ai',
          path: '/ai',
        ...
        FFRoute(
          name: 'redeemedPage',
          path: '/redeemedPage',
          builder: (context, params) => RedeemedPageWidget(),
        )

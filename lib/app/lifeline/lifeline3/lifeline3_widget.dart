...
import 'lifeline3_model.dart';
export 'lifeline3_model.dart';

class Lifeline3Widget extends StatefulWidget {
  const Lifeline3Widget({super.key});

  @override
  State<Lifeline3Widget> createState() => _Lifeline3WidgetState();
}

class _Lifeline3WidgetState extends State<Lifeline3Widget> {
  late Lifeline3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Lifeline3Model());
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(21.0, 0.0, 24.0, 0.0),
                      child: ListView(
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              if (_model.selectedOption ==
                                  columnQuestionsRecord?.correctOption) {

...
import 'lifeline_model.dart';
export 'lifeline_model.dart';

class LifelineWidget extends StatefulWidget {
  const LifelineWidget({super.key});

  @override
  State<LifelineWidget> createState() => _LifelineWidgetState();
}

class _LifelineWidgetState extends State<LifelineWidget> {
  late LifelineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LifelineModel());
